...
@section('content')
    <form class="card" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="card-body form-horizontal">
            <div class="form-group row">
                ...
                <div class="{{ $mcc }} d-flex">
                    ...
                    <div id="main_image-preview-container" class="gc__upload-preview-container"></div>
                </div>
                @error('main_image')
                <div class="{{ $lcc }}"></div>
            ...
            <div class="form-group row">
                ...
                <div class="{{ $mcc }} d-flex">
                    ...
                    <div id="images-preview-container" class="gc__upload-preview-container"></div>
                </div>
                @error('images')
                <div class="{{ $lcc }}"></div>
                <div class="{{ $mcc }} d-block invalid-feedback">
            ...
            <div class="form-group row">
                ...
                <div class="{{ $mcc }}">
                    <input type="number" min="0" class="form-control @error('price') is-invalid @enderror" name="price" id="price" value="{{ old('price') }}">
                    @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="card-footer d-flex">
            <button class="btn btn-primary ml-auto">Create Item</button>
        </div>
    </form>
@stop
